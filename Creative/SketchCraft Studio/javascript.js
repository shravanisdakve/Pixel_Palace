$(function(){
    ...
    var customAlertContainer = $('#custom-alert-container');
    var customAlertMessage = $('#custom-alert-message');
    var customAlertBtn = $('#custom-alert-btn');
    // --- END NEW ---
    ...
    $("#save").click(function(){
        ...
        {//check if the browser supports localStorage
            ...
            showAlert("Your browser does not support local storage"); // MODIFIED
        }
    });
