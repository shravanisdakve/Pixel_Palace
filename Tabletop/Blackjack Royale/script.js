...
function showCard(card, activePlayer) {
  if (activePlayer["score"] <= 21) {
    ...
    // cardImage.style = `width:${widthSize()}; height:${heightSize()};`; // REMOVED hardcoded style
    cardImage.classList.add('blackjack-card-image'); // Add a class for CSS styling
...
function widthSize() {
  if (window.innerWidth > 1000) {
    let newWidthSize = window.innerWidth * 0.1;
    return newWidthSize;
  } else {
...
function heightSize() {
  if (window.innerHeight > 700) {
    let newHeightSize = window.innerHeight * 0.18;
...
function showScore(activePlayer) {
  ...
  if (activePlayer["score"] > 21) {
    ...
    document.querySelector(activePlayer["scoreSpan"]).style.color = '#FF4136';
  } else {
...
function blackjackDeal() {
  if (blackjackGame["isTurnsOver"] === true) {
    ...
    document.querySelector("#blackjack-result").style.color = '#333333';
    ...
    document.querySelector("#your-blackjack-result").style.color = '#333333';
    document.querySelector("#dealer-blackjack-result").style.color = '#333333';
